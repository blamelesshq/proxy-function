...
func HandleRequestAzure() {
	...
	for _, element := range routeConfigObj.Functions {
		http.HandleFunc(element.Route, PrepareRequestAzure)
	}
...
func PrepareRequestAzure(w http.ResponseWriter, r *http.Request) {
...
func ProcessFetchAws(c *gin.Context) {
